...
<script lang="ts">
    ...
    async function handleViewFile(material: { name: string, type: 'pdf' | 'markdown' | 'webpage', filePath?: string, url?: string, content?: string }) {
      ...
      console.log('Viewing file:', viewingFile);  // For debugging
    }
  ...
  <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
    <div class="flex justify-between items-center p-4 bg-black dark:bg-gray-700 text-text-dark dark:text-text-dark">
    ...
    <div class="p-4 bg-black dark:bg-gray-600">
      <h3 class="text-xl font-semibold mb-4 text-text-dark dark:text-text-dark">Review Materials</h3>
